...
class BeritaListAdapterPelanggan(private val items:ArrayList<Berita>): RecyclerView.Adapter<BeritaListAdapterPelanggan.Viewholder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): BeritaListAdapterPelanggan.Viewholder {
        context=parent.context
        val binding=ViewholderBeritaBinding.inflate(LayoutInflater.from(context),parent,false)
        return Viewholder(binding)
    }

    override fun onBindViewHolder(holder: BeritaListAdapterPelanggan.Viewholder, position: Int) {
